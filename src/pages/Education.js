...
function Education() {
  return (
    <>
      <Helmet>
        <title>Utbildning & Kurser – Neves Art & Craft</title>
        <meta
          name="description"
          content="Utforska kurser och utbildningar i skogsbruk, motorsågshantering och trähantverk med certifierad instruktör Andreas Neves. Kurser för både nybörjare och yrkesverksamma."
        />
        <meta
          property="og:title"
          content="Utbildning & Kurser – Neves Art & Craft"
        />
        <meta
          property="og:description"
          content="Lär dig trädfällning och hantverk genom certifierade kurser och workshops ledda av Andreas Neves, instruktör vid Vindelns Folkhögskola."
        />
      ...
      <Box mb={8}>
        ...
        >
          ...
          <Typography variant="body1" paragraph sx={{ marginBottom: 4 }}>
            ...
            hantverksutbildning erbjuder jag certifierade kurser och workshops
            för både nybörjare och yrkesverksamma.
          </Typography>
        </Container>
              ...
              >
                ...
                <CardContent>
                  ...
                  <Typography variant="body1" paragraph>
                    - Motorsågskörkort A (Grundläggande motorsågshantering){" "}
                    <br />
        ...
        >
          ...
          <Typography variant="body1" paragraph>
            Med över ett decennium av erfarenhet inom trädfällning och
            finsnickeri är jag för närvarande kursansvarig på kursen
            Slöjd:Möbelsninckare vid Vindelns Folkhögskola. Jag har en passion
            för undervisning, möten med andra människor och att arbeta med
            hållbara material.
          </Typography>
        </Container>
